...
glyphsToRemoveString = AskString('space-separated list of glyphs to remove from selected font')
glyphsToRemove = glyphsToRemoveString.split(" ")

files = getFile("Select files to remove named glyphs from", allowsMultipleSelection=True, fileTypes=["ufo"])
